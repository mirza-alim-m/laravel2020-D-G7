        ...
        <div class="col-6">
            ...
            <form method="post" action="/pegawai/{{ $pegawai->id}}">
                ...
                <div class="form-line">
                    ...
                    <div class="fallback">
                        <img src="{{ asset($pegawai->image) }}" class="mask waves-effect waves-light rgba-white-slight"
                            height="100px" width="auto" alt="tidak ada gambar">
                        <input name="image" type="file" multiple value="{{ $pegawai->image }}" />
                    </div>
                </div>
                </div>
         <div class="form-group">
            <div class="form-line">
                ...
                <div class="fallback">
                    <input name="doc_pdf" type="file" multiple value="{{ $pegawai->doc_pdf }}" />
                </div>
            </div>
        </div>
